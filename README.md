...
8. As last step, you need to create an embedded configuration file called `tenancies.json` and store it in `environment/lib/src/main/resources/configuration/tenancies.json`. You can find a sample file in the `environment/lib/src/main/resources/configuration/tenancies.sample.json` file.